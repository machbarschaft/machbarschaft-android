            ...
            public void onClick(View view) {
                if(trusted) {
                    if(agbAcepted) {
                        ...
                        // Transfer user data in array: name, surname, address, phone number
                        String[] data = {tfName.getText().toString(), tfSurname.getText().toString(), tfAddress.getText().toString(), tfPhone.getText().toString()};
